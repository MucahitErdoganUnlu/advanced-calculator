...
char *ht_search(HashTable *table, char *key)
{
    ...
    if (item != NULL)
    {
        ...
        item = head->item;
        head = head->next;
        return item->value; // i added this
    }
...
long long int print_search(HashTable *table, char *key)      // I change it to long long int from void
{
    char *val;
...
//        printf("Key:%s does not exist\n", key);
    ...
    {
       // printf("Key:%s, Value:%s in print_search\n", key, val);
        long long int i = atoll(val);
      //  printf("val in print_search: %lld i in print_search: %lld\n", atoll(val), i);
        return  i; 
    }
}
...
int main()
{
    ...
    ht_insert(ht, (char *)"KpZ", (char *)"Fifth address");
    ...
    print_search(ht, (char *)"KpZ"); // Collision!
    print_search(ht, (char *)"Hel");
